...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2024 at 07:15 PM
...
INSERT INTO `orders` (`order_id`, `user_id`, `total_price`, `name`, `email`, `address`, `status`, `order_date`) VALUES
(2, 7, 55050.00, 'CHRIS CHIN SHENG SHIONG', 'chriskhros0126@gmail.com', 'HOUSE 16, LORONG 11, UJANA KINGFISHER LIKAS', 'Delivered', '2024-09-22 15:20:44');
...
INSERT INTO `order_items` (`order_item_id`, `order_id`, `watch_id`, `price`) VALUES
(1, 2, 5, 26700.00),
(2, 2, 4, 28350.00);
...
(7, 'chris', 'chriskhros0126@gmail.com', '$2y$10$K0K6mylK7hQJIxsbduUKuuMYMgrPpwK.pu0VEFTywtKZI40xNNtei', '2024-09-12 16:38:10', 0, 'asset/images/qr.png'),
(8, 'john', 'john@gmail.com', '$2y$10$lWKOmbTmTlAdnBWukU2PiuA2.VNctWxs9NE2SKXciFKnpBAJds4qq', '2024-09-12 16:39:07', 0, NULL),
(11, 'admin_chris', 'admin_chris@email.com', '$2y$10$cOIJ8vOLfoR.I/69x1DpweabmsluxmtL.C3JHYYTWVVBdUGq0Cyia', '2024-09-14 17:50:55', 1, NULL),
(12, 'johnytan72', 'johnytan72@gmail.com', '$2y$10$Ps5S.E0JVMreOCeik1h3XeNj5RrzfpsoOq/9RATgbL1T7iJzEhPW6', '2024-09-22 15:51:30', 0, 'asset/images/');
...
--
ALTER TABLE `watches`
  MODIFY `watch_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`watch_id`) REFERENCES `watches` (`watch_id`);
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`watch_id`) REFERENCES `watches` (`watch_id`);
